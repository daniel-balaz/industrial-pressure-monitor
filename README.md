...
| **3. Shutdown** | ![Critical](./pictures/grafana_critical.png) | Emergency threshold (5.73 kPa) reached. The "Brain" triggers a safety STOP state. |
| **4. Alerting** | ![Telegram](./pictures/telegram_alert.png) | Automatic escalation: Warning and Critical alerts sent via Telegram API. |
